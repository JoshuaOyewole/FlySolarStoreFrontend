  ...
  return (
    <div className="flex justify-center">
      <div className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6 text-gray-700 *:lg:text-lg *:leading-10 mt-6" >
          <section>
            <p className="text-sm text-gray-600 mb-4 ">
              Last Updated: 15th Nov. 2025
            </p> 
            <p>
              This Privacy Policy describes how FlySolarStore collects, uses,
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                (processed securely by our payment processor)
              </li>
              <li>
              ...
              <li>
                <strong>Usage Information:</strong> Pages visited, products
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Communicate with you about your orders and customer service
                inquiries
              </li>
          ...
          <section>
            ...
            <p className="mt-2">
              Email: privacy@flysolarstore.com
              <br />
             Shop B427 Upstairs, Alaba International Market, Lagos State
            </p>
          </section>
        </div>
      </div>
