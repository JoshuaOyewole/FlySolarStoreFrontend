...
export default function OrderConfirmationPageView() {
  return <Container className="mt-2 mb-5">
      <Wrapper>
        <Image width={116} height={116} alt="complete" src="/assets/images/party-popper.svg" />
        ...
        <StyledButton color="primary" disableElevation variant="contained" className="button-link" LinkComponent={Link} href="/products">
          Browse products
        </StyledButton>
      </Wrapper>
    </Container>;
