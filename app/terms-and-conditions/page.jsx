...
export const metadata = {
  title: "Terms & Conditions - Flysolarstore",
  description:
    "Terms and Conditions for using Flysolarstore's services and products. Read our policies on purchases, returns, and user responsibilities.",
  authors: [
    {
      name: "Orisfina Tech",
    ...
    <div className="w-full mx-auto">
      <div className="max-w-4xl xl:mt-0 xl:mb-0 xl:ml-auto! xl:mr-auto! mx-auto p-6 bg-white rounded-md my-10 flex flex-col w-4/5">
        ...
        <p className="mb-1">
          ...
          and opinions of Flysolarstore,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Flysolarstore
